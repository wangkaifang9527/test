...
var count = 0;//加载页
var size = 20;//每页加载条数
var post_list_url = url.admin_order_list
...
Page({
    ...
    onHrefOrderDetail: function (e) {
        console.log("是否可以查看详情：", e);
        console.log(this.data.orders[e.currentTarget.dataset.i]);
